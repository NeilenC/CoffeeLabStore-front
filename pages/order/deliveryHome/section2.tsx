...
const Section2 = ({ handleGoBack , address, setAddress, apartment, setApartment, directionNum, setDirectionNum, codigo, setCodigo, localidad, setLocalidad, handleNextSection }: any) =>{ 
