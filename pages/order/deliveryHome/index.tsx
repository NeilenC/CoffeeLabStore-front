...
const DeliveryHome = () => {
  ...
  const handlePlaceOrder = async () => {
    ...
    if (section === 3) {
        ...
        if (paymentMethod === 'tarjetaDebito' || paymentMethod === 'tarjetaCredito') {
  ...
  return (
    <Box sx={{ display: 'flex', direction: 'column', bgcolor: '#F5f5f5f5', p:10 }}>
      <Box sx={{  m: 'auto' }}>
      {/* <LockIcon/>  */}
      <Box sx={{mb:3}}>

      <Box sx={{fontSize:"20px", bgcolor:"white", p:3, borderRadius:5}}> Tu compra es totalmente segura y confidencial </Box>
