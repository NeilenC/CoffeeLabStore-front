  ...
  return (
    <Box sx={{ p: 5 }}>
      {searchResults.length ? (
        <>
          <Typography variant="h5" sx={{ maxWidth: "1200px", m: "auto" }}>
            {" "}
            Estos son los resultados que coinciden con tu búsqueda:
          </Typography>
        ...
        <Box>
          <Typography>
            Lo sentimos, no encontramos productos para tu búsqueda
          </Typography>
        </Box>
      )}
    </Box>
